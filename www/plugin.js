...
function () {
   ...
   */
  Purchases.setup = function setup(apiKey, appUserID, observerMode) {
    if (observerMode === void 0) {
      observerMode = false;
    }
  ...
  Purchases.setAllowSharingStoreAccount = function setAllowSharingStoreAccount(allowSharing) {
  ...
  Purchases.addAttributionData = function addAttributionData(data, network, networkUserId) {
    window.cordova.exec(null, null, PLUGIN_NAME, "addAttributionData", [data, network, networkUserId]);
  }
  /**
  ...
  Purchases.getEntitlements = function getEntitlements(callback, errorcallback) {
  ...
  Purchases.getProducts = function getProducts(productIdentifiers, callback, errorcallback, type) {
    if (type === void 0) {
      type = "subs";
    }
  ...
  Purchases.makePurchase = function makePurchase(productIdentifier, callback, errorcallback, oldSku, type) {
    if (type === void 0) {
      type = "subs";
    }
    ...
    window.cordova.exec(callback, errorcallback, PLUGIN_NAME, "makePurchase", [productIdentifier, oldSku, type]);
  }
  /**
  ...
  Purchases.restoreTransactions = function restoreTransactions(callback, errorcallback) {
  ...
  Purchases.getAppUserID = function getAppUserID(callback) {
  ...
  Purchases.createAlias = function createAlias(newAppUserID, callback, errorcallback) {
    window.cordova.exec(callback, errorcallback, PLUGIN_NAME, "createAlias", [newAppUserID]);
  }
  /**
  ...
  Purchases.identify = function identify(newAppUserID, callback, errorcallback) {
    window.cordova.exec(callback, errorcallback, PLUGIN_NAME, "identify", [newAppUserID]);
  }
  /**
  ...
  Purchases.reset = function reset(callback, errorcallback) {
  ...
  Purchases.getPurchaserInfo = function getPurchaserInfo(callback, errorcallback) {
  ...
  Purchases.setDebugLogsEnabled = function setDebugLogsEnabled(enabled) {
    window.cordova.exec(null, null, PLUGIN_NAME, "setDebugLogsEnabled", [enabled]);
  }
  /**
  ...
  Purchases.syncPurchases = function syncPurchases() {
